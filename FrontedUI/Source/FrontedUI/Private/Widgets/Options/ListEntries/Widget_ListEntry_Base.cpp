...
void UWidget_ListEntry_Base::OnOwningDependencyDataObjectModified(UListDataObject_Base* OwningDependencyModifiedData, EOptionsListDataModifyReason ModifyReason)
{
